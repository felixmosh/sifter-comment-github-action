...
;// CONCATENATED MODULE: ./src/extractIssueIds.ts
function extractIssueIds(messages) {
    return messages
        .flatMap((message) => {
...
function getConfig() {
    return Object.entries(Inputs).reduce((result, [key, value]) => {
        result[key] = (0,core.getInput)(value, {
            required: true,
            trimWhitespace: true,
        });
        return result;
...
;// CONCATENATED MODULE: ./src/sifterApi.ts
...
;// CONCATENATED MODULE: ./src/postCommentsOn.ts
